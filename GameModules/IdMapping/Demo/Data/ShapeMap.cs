namespace GameModules.IdMapping.Demo.Data
{
    ...
    [CreateAssetMenu(menuName = "Game/Maps/Shape Map", fileName = "Shape Map")]
    public class ShapeMap : ScriptableObject
    {
        [InlineProperty]
        [HideLabel]
        public ShapeData value = new();
        ...
        public static void GenerateStaticProperties(ShapeMap map)
        {
            var idType = typeof(ShapeId);
            var idTypeName = nameof(ShapeId);
